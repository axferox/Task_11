...
yargs
  .command({
    ...
    description: "Start test with a full command like: 'npm run cucumber test smoke chrome 96 mac localhost'",
    builder: {
      testType: {
    ...
    handler(argv) {
      ...
      exec(`npx cucumber-js -t @${argv.testType} --format usage-json:features/cucumber_reports.json
`, (stdout, stderr) => {
